...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.model= YOLO("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/best_12.pt")
        self.model= YOLO("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/best_train15.pt")
        ### Run before to do not initie
        img = cv2.imread('/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/image_to_handle.png')
        ...
        data_backup_read= open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup.txt","r")
        ...
        self.path_backup='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_backup_everyday'
        ...
        self.ui.display_value_pin.setText(str(self.value_pin))
        self.ui.display_value_screw.setText(str(self.value_screw))
        self.ui.display_value_push_aid.setText(str(self.value_push_aid))
        self.ui.login.hide()

        #######ADDD more xu ly 3 thanh keo gia tri
        self.ui.value_pin.valueChanged.connect(self.update_five_value)
        self.ui.value_screw.valueChanged.connect(self.update_five_value)
        self.ui.value_push_aid.valueChanged.connect(self.update_five_value)
    ...
    daemon=True
        ...
        self.path_folder_adjust='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate'
        self.mode_adjust=False
        self.ui.adjust.hide()
        self.ui.but_config.hide()
    ...
    ########## ADD more
    def update_five_value(self):
        self.value_pin=int(self.ui.value_pin.value())
        self.value_screw=int(self.ui.value_screw.value())
        self.value_push_aid= int(self.ui.value_push_aid.value())

        self.ui.display_value_pin.setText(str(self.value_pin))
        self.ui.display_value_screw.setText(str(self.value_screw))
        self.ui.display_value_push_aid.setText(str(self.value_push_aid))

        data_backup_write=open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_point_backup.txt","w")
        data_all_write = [str(self.over_point)+"\n"+str(self.break_point)+"\n" +str(self.value_pin)+"\n" +str(self.value_screw)+ "\n"+str(self.value_push_aid)]
    ...
    def read_again_value_camera_adjust(self):
        ...
        file_read_value_adjust= open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_value_adjust_camera.txt","r")
    ...
    def upgrade_parameter_camera(self):
        ...
        data_backup_write=open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_value_adjust_camera.txt","w")
...
####################################### widget adjust###################################
    ...
    def history_adjust(self):
        ...
        path_txt_NG='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate_txt/'
    ...
    def save_value_adjust(self):
        ...
        data_backup_write=open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_value_adjust.txt","w")
    ...
    def read_again_value_adjust(self):
        # doc fil du lieu adjust a
        file_read_value_adjust= open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_value_adjust.txt","r")
        file_read_value_adjust=file_read_value_adjust.readlines()
...
#########################################################################################
    def load_point_backup(self):
        file_to_read= open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_point_backup.txt","r")
        file_to_read=file_to_read.readlines()
        # print(file_to_read)
        self.over_point=int(file_to_read[0])
        self.break_point=int(file_to_read[1])

        self.value_pin=int(file_to_read[2])
        self.value_screw=int(file_to_read[3])
        self.value_push_aid=int(file_to_read[4])
        # return None
        self.ui.value_over.setValue(self.over_point)
        self.ui.value_break.setValue(self.break_point)

        self.ui.value_pin.setValue(self.value_pin)
        self.ui.value_screw.setValue(self.value_screw)
        self.ui.value_push_aid.setValue(self.value_push_aid)

    def clear_listwidget(self):
        self.ui.space_to_display_history_NG.clear()
        self.ui.listWidget_NG.clear()

        path_txt_NG='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup_everyday_txt/'
        path_list_ptxt_NG= ((os.listdir(os.path.expanduser(path_txt_NG))))
    ...
    def display_on_gui(self):
        ...
        if self.stage.value==1 and self.mode_running_gui==True:
            ...
            img=cv2.imread("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/image_to_save.png",0)
            # print(img.shape)
            ...
            if img is not None:
                ...
                data_backup_write=open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup.txt","w")
    ...
    def restore_data(self): # dùng để chuyển dữ liệu từ file này sang 1 file backup dự phòng
        ...
        source_file_path = '/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup.txt'
        destination_file_path = '/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup_v1.txt'
    ...
    def swap_file_data_bakcup(self):
        # Đường dẫn tới file nguồn và file đích
        destination_file_path = '/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup.txt'
        source_file_path = '/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup_v1.txt'
    ...
    def conveyor_running_count(self,frame_gray):
        folder_path_before='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate'### luu giu lieu truoc khi anh duoc xoay
        folder_path_after='/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_after_rorate'### luu giu lieu truoc khi anh duoc xoay
        self.folder_path_save= '/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_save'  ### luu giu lieu sau khi anh duoc xoay
        self.banana+=1
        ...
        if self.banana>1 :
            ...
            if (self.banana-self.banana_ate>20): ## nếu quá 5 khung hình mà không nhận được rằng có sự chuyển động thì xử lý 
                ...
                if self.count_times>self.over_point: # khi vượt qua điểm giới hạn thì kích hoạt việc xoay hình 
                    if self.mode_auto_scan==False:
                        ...
                        path_txt_img_before= open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate_txt/" + str(self.count_sum)+'.txt',"w",errors = "ignore")  # lưu file text
            ...
            #     # print(1)
                ...
                cv2.imwrite('/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/image_to_handle.png', rotate_image)
                    ...
                    if results[0].obb[i].conf>0.75:
                        ...
                        for data in datas:
                            ...
                            if results[0].names[id.item()]=='pin':
                                ...
                                if count_aid==self.value_push_aid:
                                # Vẽ OBB lên ảnh (màu xanh lá cây và đường viền dày 2 pixel)
                                    cv2.polylines(img, [points], isClosed=True, color=(0, 0, 255), thickness=2)
                                else:
                                    cv2.polylines(img, [points], isClosed=True, color=(255, 0, 0), thickness=2)
                                ...
                                if count_screw==self.value_screw:
                                # Vẽ OBB lên ảnh (màu xanh lá cây và đường viền dày 2 pixel)
                                    cv2.polylines(img, [points], isClosed=True, color=(0, 0, 255), thickness=2)
                                else:
                                    cv2.polylines(img, [points], isClosed=True, color=(255, 0, 0), thickness=2)
                ...
                if count_ng==0:
                    if count_pin==self.value_pin and count_screw ==self.value_screw and count_aid==self.value_push_aid:
                ...
                if self.mode_NG==True:
                    ...
                    name_NG =str(datetime.now())[0:19] + ' HangNG so '+ str(self.count_ng)
                    ...
                    path_txt_NG = open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup_everyday_txt/" + name_NG_txt,"w",errors = "ignore")  # lưu file text
                    path_txt_NG.close()
    ...
    def detect_number_of_component(self,img):
        ...
        ####check push pin
            ...
            if self.mode_NG==True :
                ...
                path_txt_NG = open("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/data_backup_everyday_txt/" + name_NG_txt,"w",errors = "ignore")
                path_txt_NG.close()
                self.update_listwidget()
            ...
            self.mode_NG=False
            cv2.imwrite('/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/image_target.png', reconstructed_img)            
    ...
    def display_right_img_on_gui(self):
        # out screen3
        right_img=cv2.imread("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/Right_picture.jpg",1)
    ...
    def reset(self):
        if self.mode_reset==False:
            ...
            paths=["/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate","/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data_before_rorate_txt"]
    ...
    def loggin(self):
        ...
        if ID=="Pronics Long An" and password=='1255':
            self.ui.lineEdit_2.clear()
            self.time_start_log_out=time.time()
    ...
    def save_daily_data(self):
        ...
        cv2.imwrite("/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/Data_end_of_day/Tongket_ngay_" + str(datetime.now())[0:16] + ".jpg",np.float32(img_of_the_end_day))
        main_win.close()
    ...
    while True:
        ...
        # try:
            if grabResult.GrabSucceeded():
                ...
                if mode.value==0:
                    cv2.imwrite('/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/data/image_to_save.png',image_grabed_resize)
                    mode.value=1
            ...
            with open('/home/pronics-super/Desktop/hunghung_back_data/software_Y_Hook/Gui/error_log.txt', 'w') as log_file:
